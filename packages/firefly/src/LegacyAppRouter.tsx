...
import { useIsMswReady } from "@squide/msw";
...
export function BootstrappingRoute(props: BootstrappingRouteProps) {
    ...
    const isMswStarted = useIsMswReady(waitForMsw);
...
export type LegacyRenderRouterProviderFunction = (routes: Route[], providerProps: Omit<RouterProviderProps, "router">) => ReactElement;

export interface LegacyAppRouterProps {
    fallbackElement: ReactElement;
    ...
    onCompleteRegistrations?: OnCompleteRegistrationsFunction;
    waitForMsw: boolean;
    children: LegacyRenderRouterProviderFunction;
}

export function LegacyAppRouter(props: LegacyAppRouterProps) {
    const {
        fallbackElement,
        errorElement,
        onLoadPublicData,
