...
// export function useIsRouteMatchProtected(locationArg: Partial<Location>, { throwWhenThereIsNoMatch = true }: UseIsRouteMatchProtectedOptions = {}) {
//     const activeRoute = useRouteMatch(locationArg);

//     console.log("YYYYYYYYYYYYYYYYYYYYYYYYYY", activeRoute);
