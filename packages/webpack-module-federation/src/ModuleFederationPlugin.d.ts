// Duplicated from https://github.com/webpack/webpack/blob/main/declarations/plugins/container/ModuleFederationPlugin.d.ts
// because the type is not exported from https://github.com/webpack/webpack/blob/main/types.d.ts
// and the "declarations" folder is not included in the package.
...
/**
 * Modules that should be shared in the share scope. Property names are used to match requested modules in this compilation. Relative requests are resolved, module requests are matched unresolved, absolute paths will match resolved requests.
