...
import { createRemoteTransformer } from "@squide/webpack-module-federation/configTransformer.js";
...
export default defineBuildConfig(swcConfig, {
    entry: "./src/register.tsx",
    // The trailing / is very important, otherwise paths will ne be resolved correctly.
    publicPath: isNetlify ? "https://squide-remote-module.netlify.app/" : "http://locahost:8081/",
