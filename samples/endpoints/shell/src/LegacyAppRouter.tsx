...
import { LegacyAppRouter as FireflyAppRouter, completeModuleRegistrations, useLogger, useRuntime, type Logger } from "@squide/firefly";
...
export function AppRouter({ waitForMsw, sessionManager, telemetryService }: LegacyAppRouterProps) {
